...
<head>
  ...
  <title>Fastprint | Dashboard</title>
  ...
  <link rel="stylesheet" href="<?php echo base_url('assets_admin/plugins/bootstrap-wysihtml5/bootstrap3-wysihtml5.min.css')?>">
   <!-- DataTables -->
  <link rel="stylesheet" href="<?php echo base_url('assets_admin/bower_components/datatables.net-bs/css/dataTables.bootstrap.min.css')?>">
